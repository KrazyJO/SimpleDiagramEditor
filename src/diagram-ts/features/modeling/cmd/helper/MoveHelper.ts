...
export default class MoveHelper {
   ...
   */
	public moveRecursive(elements: any, delta: Point, newParent: any): any {
		if (!elements) {
			return [];
		} else {
	 ...
	 */
	public moveClosure(closure: any, delta: Point, newParent: any, newHost?: any, primaryShape?: any): void {
