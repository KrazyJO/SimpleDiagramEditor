...
export default class Create {
	...
	constructor(
		...
		function createVisual(shape: any) {
		...
		eventBus.on('create.move', function (event: any) {
		...
		eventBus.on('create.move', LOW_PRIORITY, function (event: any) {
		...
		eventBus.on(['create.end', 'create.out', 'create.cleanup'], function (event: any) {
			var context = event.context,
		...
		eventBus.on('create.end', function (event: any): boolean | void {
			var context = event.context,
				source = context.source,
				shape = context.shape,
				target = context.target,
				canExecute = context.canExecute,
				attach: any = canExecute && canExecute.attach,
		...
		eventBus.on('create.cleanup', function (event: any) {
			var context = event.context;
		...
		this.start = function (event: any, shape: any, source: any) {
