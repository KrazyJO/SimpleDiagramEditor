...
export default class EventBus {
	 ...
	 * @param {Object} [that] Pass context (`this`) to the callback
	 */
	public once(event : any, priority : number | Function, callback? : any, that? : any) {
		var self = this;
	 ...
	 */
	private _addListener(event : string, newListener : any) : void {
 ...
 * @return {Any}
 */
function invokeFunction(fn : Function, args : any[]) {
