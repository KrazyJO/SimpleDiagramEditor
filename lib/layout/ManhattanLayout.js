import { isArray, find, without, assign } from 'min-dash';
import { getOrientation, getMid } from './LayoutUtil';
import { pointInRect, pointDistance, pointsAligned } from '../util/Geometry';
...
export function getBendpoints(a, b, directions) {
    ...
    if (directions === 'v:v') {
        ...
        throw new Error('unknown directions: <' + directions + '>: ' +
...
//# sourceMappingURL=ManhattanLayout.js.map