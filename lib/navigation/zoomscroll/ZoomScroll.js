...
var ZoomScroll = /** @class */ (function () {
    ...
    ZoomScroll.prototype.scroll = function (delta) {
        this._canvas.scroll(delta);
    };
    ;
    ZoomScroll.prototype.reset = function () {
     ...
     */
    ZoomScroll.prototype.zoom = function (delta, position) {
    ...
    ;
    ZoomScroll.prototype._handleWheel = function (event) {
        ...
        if (isZoom) {
            ...
            delta = (Math.sqrt(Math.pow(event.deltaY, 2) +
                Math.pow(event.deltaX, 2)) * sign(event.deltaY) * factor);
     ...
     * @param {Object} position - Zoom position.
     */
    ZoomScroll.prototype.stepZoom = function (delta, position) {
     ...
     */
    ZoomScroll.prototype.toggle = function (newEnabled) {
        var element = this._container;
...
//# sourceMappingURL=ZoomScroll.js.map