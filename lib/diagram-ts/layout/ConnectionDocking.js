 ...
 * @constructor
 */
var ConnectionDocking = /** @class */ (function () {
   ...
   */
    ...
    ConnectionDocking.prototype.getDockingPoint = function (connection, shape, dockStart) {
        var waypoints = connection.waypoints, dockingIdx, dockingPoint;
    ...
    ;
    return ConnectionDocking;
}());
export default ConnectionDocking;
//# sourceMappingURL=ConnectionDocking.js.map