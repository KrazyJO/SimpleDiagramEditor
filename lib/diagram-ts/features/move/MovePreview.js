import { flatten, forEach, filter, find, groupBy, map, matchPattern, size } from 'min-dash';
 ...
 * @param {Styles} styles
 */
var MovePreview = /** @class */ (function () {
...
function removeEdges(elements) {
    var filteredElements = filter(elements, function (element) {
        if (!isConnection(element)) {
            ...
            return (find(elements, matchPattern({ id: element.source.id })) &&
...
//# sourceMappingURL=MovePreview.js.map