...
var Dragging = /** @class */ (function () {
    function Dragging(eventBus, canvas, selection) {
        ...
        function move(event, activate) {
            ...
            var globalStart = context.globalStart, globalCurrent = toPoint(event), globalDelta = substract(globalCurrent, globalStart);
            var localStart = context.localStart, localCurrent = toLocalPoint(globalCurrent), localDelta = substract(localCurrent, localStart);
