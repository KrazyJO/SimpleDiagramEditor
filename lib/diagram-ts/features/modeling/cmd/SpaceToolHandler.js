 ...
 */
var SpaceToolHandler = /** @class */ (function () {
    function SpaceToolHandler(modeling) {
        this._modeling = modeling;
    }
    SpaceToolHandler.prototype.preExecute = function (context) {
        // resize
        var modeling = this._modeling, resizingShapes = context.resizingShapes, delta = context.delta, direction = context.direction;
    ...
    SpaceToolHandler.prototype.postExecute = function (context) {
        // move
        var modeling = this._modeling, movingShapes = context.movingShapes, delta = context.delta;
...
export default SpaceToolHandler;
//# sourceMappingURL=SpaceToolHandler.js.map