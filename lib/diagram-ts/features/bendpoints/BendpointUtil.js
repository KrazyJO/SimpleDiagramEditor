...
function createParallelDragger(parentGfx, position, alignment) {
    ...
    var width = 14, height = 3, padding = 6, hitWidth = width + padding, hitHeight = height + padding;
...
export function addSegmentDragger(parentGfx, segmentStart, segmentEnd) {
    var groupGfx = svgCreate('g'), mid = getMidPoint(segmentStart, segmentEnd), alignment = pointsAligned(segmentStart, segmentEnd);
    svgAppend(parentGfx, groupGfx);
...
//# sourceMappingURL=BendpointUtil.js.map