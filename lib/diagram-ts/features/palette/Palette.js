import { isFunction, isArray, forEach } from 'min-dash';
...
var PALETTE_OPEN_CLS = 'open', PALETTE_TWO_COLUMN_CLS = 'two-column';
/**
 ...
 */
    ...
    Palette.prototype._init = function () {
        ...
        var parent = canvas.getContainer(), container = this._container = domify(Palette.HTML_MARKUP), self = this;
    ...
    Palette.prototype._update = function () {
        var entriesContainer = domQuery('.djs-palette-entries', this._container), entries = this._entries = this.getEntries();
