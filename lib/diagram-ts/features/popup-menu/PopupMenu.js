import { forEach, assign, find, matchPattern, } from 'min-dash';
import { delegate as domDelegate, domify as domify, classes as domClasses, attr as domAttr, remove as domRemove } from 'min-dom';
...
PopupMenu.prototype.open = function (position) {
    ...
    this._emit('open');
    var current = this._current, canvas = this._canvas, parent = canvas.getContainer();
...
PopupMenu.prototype.trigger = function (event) {
    ...
    var element = event.delegateTarget || event.target, entryId = domAttr(element, DATA_REF);
...
PopupMenu.prototype._createEntries = function (entries, className) {
    var entriesContainer = domify('<div>'), self = this;
...
PopupMenu.prototype._createEntry = function (entry) {
    ...
    var entryContainer = domify('<div>'), entryClasses = domClasses(entryContainer);
