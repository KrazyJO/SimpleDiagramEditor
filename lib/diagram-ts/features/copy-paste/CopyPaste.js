import { isArray, forEach, map, matchPattern, find, findIndex, sortBy, reduce } from 'min-dash';
...
var CopyPaste = /** @class */ (function () {
   ...
   */
    CopyPaste.prototype.copy = function (selectedElements) {
        var clipboard = this._clipboard, tree, bbox;
    ...
    CopyPaste.prototype.paste = function (context) {
        var clipboard = this._clipboard, modeling = this._modeling, eventBus = this._eventBus, rules = this._rules;
        var tree = clipboard.get(), topParent = context.element, position = context.point, newTree, canPaste;
    ...
    CopyPaste.prototype.createTree = function (elements) {
        ...
        var tree = {}, includedElements = [], _elements;
        ...
        function includeElement(data) {
            var idx = findIndex(includedElements, matchPattern({ element: data.element })), element;
            if (idx !== -1) {
