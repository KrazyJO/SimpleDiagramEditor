import { isObject, assign, pick, forEach, reduce } from 'min-dash';
// import {
// 	append as svgAppend,
// 	attr as svgAttr,
// 	create as svgCreate,
// 	remove as svgRemove
// } from 'tiny-svg';
var _a = require('tiny-svg'), append = _a.append, attr = _a.attr, create = _a.create, remove = _a.remove;
...
Text.prototype.layoutText = function (text, options) {
    var box = assign({}, this._config.size, options.box), style = assign({}, this._config.style, options.style), align = parseAlign(options.align || this._config.align), padding = parsePadding(options.padding !== undefined ? options.padding : this._config.padding), fitBox = options.fitBox || false;
