...
var EventBus = /** @class */ (function () {
    ...
    EventBus.prototype.on = function (events, priority, callback, that) {
        ...
        var self = this, listener = { priority: priority, callback: actualCallback };
    ...
    EventBus.prototype.off = function (event, callback) {
        var listeners = this._getListeners(event), listener, listenerCallback, idx;
        if (callback) {
    ...
    EventBus.prototype._addListener = function (event, newListener) {
        var listeners = this._getListeners(event), existingListener, idx;
 ...
 */
var InternalEvent = /** @class */ (function () {
