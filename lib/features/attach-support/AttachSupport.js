import { flatten, filter, forEach, groupBy, map, unionBy } from 'min-dash';
...
export default function AttachSupport(injector, eventBus, rules, modeling) {
    ...
    this.postExecuted('elements.move', function (event) {
        var context = event.context, delta = context.delta, newParent = context.newParent, closure = context.closure, enclosedElements = closure.enclosedElements, attachers = getAttachers(enclosedElements);
...
//# sourceMappingURL=AttachSupport.js.map