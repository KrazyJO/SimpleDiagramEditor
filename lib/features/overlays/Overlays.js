import { isArray, isString, isObject, assign, forEach, find, filter, matchPattern, } from 'min-dash';
 ...
 */
    ...
    Overlays.prototype._updateOverlayVisibilty = function (overlay, viewbox) {
        ...
        if (show) {
            if ((isDef(minZoom) && minZoom > viewbox.scale) ||
