 ...
 *
 */
var DeleteShapeHandler = /** @class */ (function () {
    ...
    DeleteShapeHandler.prototype.preExecute = function (context) {
        ...
        var shape = context.shape, label = shape.label;
    ...
    DeleteShapeHandler.prototype.revert = function (context) {
        var canvas = this._canvas;
        var shape = context.shape, oldParent = context.oldParent, oldParentIndex = context.oldParentIndex, labelTarget = context.labelTarget;
    ...
    return DeleteShapeHandler;
}());
export default DeleteShapeHandler;
function isConnection(element) {
    return element.waypoints;
}
//# sourceMappingURL=DeleteShapeHandler.js.map