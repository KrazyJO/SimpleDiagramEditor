import { assign, filter, groupBy } from 'min-dash';
...
var MoveEvents = /** @class */ (function () {
    function MoveEvents(eventBus, dragging, modeling, selection, rules) {
        ...
        eventBus.on('shape.move.move', LOW_PRIORITY, function (event) {
            var context = event.context, validatedShapes = context.validatedShapes, hover = event.hover, delta = { x: event.dx, y: event.dy }, position = { x: event.x, y: event.y }, canExecute;
            // check if we can move the elements
