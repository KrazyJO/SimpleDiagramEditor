import { isNumber as isNumber, assign as assign, forEach as forEach, every as every, debounce as debounce, bind as bind, reduce as reduce } from 'min-dash';
import { add as collectionAdd, remove as collectionRemove } from '../util/Collections';
import { getType } from '../util/Elements';
import { append as svgAppend, attr as svgAttr, classes as svgClasses, create as svgCreate, transform as svgTransform, createMatrix as createMatrix } from 'tiny-svg';
 ...
 */
    ...
    Canvas.prototype.viewbox = function (box) {
        ...
        var viewport = this._viewport, innerBox, outerBox = this.getSize(), matrix, transform, scale, x, y;
        if (!box) {
